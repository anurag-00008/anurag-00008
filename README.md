...
- ⚙️ Interested in **distributed systems, API design, and developer tooling**
...
**Senior Secondary (CBSE) — PCM + CS** | Green Point Academy · 82% *(2021 – 2023)*
...
- **Docker & CI/CD** — containerization workflows and deployment pipelines
- **DSA** — consistently solving problems on LeetCode / GeeksForGeeks
